...
class AppBootstrap:
    """Small dependency container for this MVP foundation.

    Keeping dependencies centralized makes future refactors safer,
    especially when the project grows into more services and pages.
    """
